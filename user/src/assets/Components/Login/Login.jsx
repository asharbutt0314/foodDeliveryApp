    ...
    try {
      ...
      if (err.response?.status === 403 && errorMessage.includes("not verified")) {
        ...
        try {
          ...
          const failMessage = "User not verified. Failed to send OTP automatically. Please try resending manually.";
        ...
        <div className="col-lg-5 col-md-7">
          <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
            <div className="card-header text-white text-center py-4" style={{ background: 'linear-gradient(135deg, #FF5722 0%, #FF9800 100%)' }}>
              ...
              <p className="mb-0 mt-2" style={{ opacity: '0.9' }}>Login to order delicious food</p>
            </div>
            ...
            <div className="card-body p-4" style={{ background: 'linear-gradient(145deg, #ffffff, #f8f9fa)' }}>
              <form onSubmit={handleLogin}>
                ...
                <div className="text-center mt-3">
                  ...
                  <p className="text-muted">Don't have an account? <a href="/signup" style={{ color: '#FF5722', textDecoration: 'none', fontWeight: 'bold' }}>Sign up here</a></p>
                </div>
              </form>
            </div>
          </div>
