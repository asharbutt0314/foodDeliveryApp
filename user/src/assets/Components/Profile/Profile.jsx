...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const updateData = { username, userId: user._id };
      if (password) {
        updateData.password = password;
      }

      const res = await axios.put('http://localhost:5000/auth/update-profile', updateData);
      ...
      if (res.data.success) {
        ...
        setUser(updatedUser);
        setPassword('');
        // Redirect to restaurants page and refresh
        ...
        <div className="col-lg-6 col-md-8">
          <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
            <div className="card-header text-white text-center py-4" style={{ background: 'linear-gradient(135deg, #FF5722 0%, #FF9800 100%)' }}>
              ...
              <p className="mb-0 mt-2" style={{ opacity: '0.9' }}>Manage your account information</p>
            </div>
